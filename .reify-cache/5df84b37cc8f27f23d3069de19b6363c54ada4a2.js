"use strict";module.export({default:()=>Scope});var reserved;module.watch(require('../utils/reserved.js'),{default:function(v){reserved=v}},0);var CompileError;module.watch(require('../utils/CompileError.js'),{default:function(v){CompileError=v}},1);
