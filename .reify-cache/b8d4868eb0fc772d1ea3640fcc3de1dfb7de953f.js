"use strict";module.export({default:()=>Program});var MagicString;module.watch(require('magic-string'),{default:function(v){MagicString=v}},0);var wrap;module.watch(require('./wrap.js'),{default:function(v){wrap=v}},1);var BlockStatement;module.watch(require('./BlockStatement.js'),{default:function(v){BlockStatement=v}},2);var Scope;module.watch(require('./Scope.js'),{default:function(v){Scope=v}},3);var check;module.watch(require('./check.js'),{default:function(v){check=v}},4);
