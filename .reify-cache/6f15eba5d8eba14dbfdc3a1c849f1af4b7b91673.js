"use strict";module.export({default:()=>CatchClause});var Node;module.watch(require('../Node.js'),{default:function(v){Node=v}},0);var Scope;module.watch(require('../Scope.js'),{default:function(v){Scope=v}},1);var extractNames;module.watch(require('../extractNames.js'),{default:function(v){extractNames=v}},2);
