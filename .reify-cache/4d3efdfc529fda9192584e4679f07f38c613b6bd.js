"use strict";module.export({default:()=>BinaryExpression});var Node;module.watch(require('../Node.js'),{default:function(v){Node=v}},0);var UNKNOWN;module.watch(require('../../utils/sentinels.js'),{UNKNOWN:function(v){UNKNOWN=v}},1);var stringify;module.watch(require('../../utils/stringify.js'),{default:function(v){stringify=v}},2);
