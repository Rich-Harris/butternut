"use strict";module.export({default:()=>check});var parse;module.watch(require('acorn'),{parse:function(v){parse=v}},0);var decode;module.watch(require('sourcemap-codec'),{decode:function(v){decode=v}},1);var keys;module.watch(require('./keys.js'),{default:function(v){keys=v}},2);var Program;module.watch(require('./Program.js'),{default:function(v){Program=v}},3);
