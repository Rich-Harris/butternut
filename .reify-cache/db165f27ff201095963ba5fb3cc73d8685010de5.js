"use strict";module.export({default:()=>AssignmentExpression});var Node;module.watch(require('../Node.js'),{default:function(v){Node=v}},0);var CompileError;module.watch(require('../../utils/CompileError.js'),{default:function(v){CompileError=v}},1);
