"use strict";module.export({default:()=>IfStatement});var Node;module.watch(require('../Node.js'),{default:function(v){Node=v}},0);var UNKNOWN;module.watch(require('../../utils/sentinels.js'),{UNKNOWN:function(v){UNKNOWN=v}},1);
